...
export function FleetStatus() {
  const statusCounts = {
    active: mockTrucks.filter(t => t.status === 'active').length,
    maintenance: mockTrucks.filter(t => t.status === 'maintenance').length,
    inactive: mockTrucks.filter(t => t.status === 'inactive').length,
  };
